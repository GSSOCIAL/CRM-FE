<script setup lang="ts">
  ...
  const login = ()=>{
    $api.identity.login({email: form.value.email, password: form.value.password}).then((response)=>{
  ...
  <PageWrapper>
    <div class="loginPageContainer">
      <div class="loginPageHeader">
        <div class="loginPageLabel">Welcome back!</div>
        <div class="loginPageDescription">Welcome back! Please enter your login credentials</div>
      </div>
