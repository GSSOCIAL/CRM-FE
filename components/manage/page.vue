...
const isColumnsManagePopupShowed = useState(
  "isColumnsManagePopupShowed",
  () => false
);
...
<template>
  <Button
    ...
    "
  >
    {{ $t("dashboard.actions.manageColumns") }}
  </Button>
  <Button
    type="clean"
    size="small"
  ...
  <Popup
    v-if="isColumnsManagePopupShowed"
    @close="
      () => {
  ...
  >
    ...
    >
      ...
      <template v-slot:description
        >Select columns you like to see on this dashboard</template
      >
    </PopupHead>
